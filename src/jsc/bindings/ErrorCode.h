...
::JSC::EncodedJSValue CRYPTO_INVALID_KEY_OBJECT_TYPE(::JSC::ThrowScope& throwScope, ::JSC::JSGlobalObject* globalObject, uint8_t receivedType, ::WTF::ASCIILiteral expected);
